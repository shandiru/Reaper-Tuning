...
const testimonials = [
{
  text: "Just received my car back from Reaper tuning what a difference. The car feels like new and is performing brilliant. Great service and all details of the service and work fully explained.",
  name: "shaun morris",
}
