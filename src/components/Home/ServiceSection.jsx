...
const services = [
  {
    title: "Vehicle Tuning & Remapping",
    desc: "Optimize your car's performance with professional tuning and remapping services.",
    image: "/vehicle-tuning-remapping.avif",
    path: "/services/vehicle-tuning-remapping",
  },
  {
    title: "AdBlue, NOx, DPF & EGR Solutions",
    desc: "Expert solutions and diagnostics for AdBlue, NOx, DPF, and EGR systems.",
    image: "/adblue-nox-dpf-egr.avif",
    path: "/services/adblue-nox-dpf-egr",
  },
  {
    title: "Keys, Fobs & Remotes Coding",
    desc: "Coding and programming of car keys, fobs, and remotes for all major vehicles.",
    image: "/keys-fobs-remotes.avif",
    path: "/services/keys-fobs-remotes",
  },
];
              ...
              >
                ...
                <div className="max-w-sm mx-auto bg-white">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-auto  bg-white "
                    onError={(e) => {
